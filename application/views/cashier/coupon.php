        ...
        <div class=" container-fluid mt20">
            <div class="row mb-3 align-items-center">
                  <div class="col-md-8">
                      ...
                      <button class="" style="background: #EC4D4D;border-color: #EC4D4D; color: #ffffff;border-radius: 0;height: 56px;width: 161px;outline: none;">Coupon Management</button>
                  ...
                  <a href="<?=base_url(); ?>cashier/createcoupon">
                    <button type="button" class="btn btn-success loyal" <?php if(empty($this->session->userdata["admindata"]) && $this->data['create_coupon'] == 0){echo 'disabled'; }else{ echo '';} ?>>Create Coupon</button>
                  </a>
                  <a href="<?php echo base_url(); ?>cashier/couponArchive" >
                      <button class="btn btn-success" id="archive_all">Archive</button>
                  </a>
                  <div class="col-md-2 text-right">
                    <button <?php if(empty($this->session->userdata["admindata"]) && $this->data['delete_coupon'] == 0){echo 'disabled'; }else{ echo '';} ?> name="delete_all" id="delete_all" class="btn btn-danger trash" style="height: 38px;"><i class="fa fa-trash"></i>
                    </button>
                  </div>
            </div>
         <div class="row">
                             ...
                             <div class="">
                                 <table class="table table-sm cell-border" id="tbl_coupon">
                                     ...
                                     <tbody>
                                      ...
                                      <tr>
                                          <td style='width: 2.5%;'   class="text-center"><input type="checkbox" class="delete_checkbox1" value="<?=$c['coupon_id']?>" /></td>
                                          ...
                                          <td  class=" dt-center"><a href="<?=base_url()?>cashier/edit_coupon?id=<?=$c['coupon_id']?>"><button type="button" class="btn  btn-style " <?php if(empty($this->session->userdata["admindata"]) && $this->data['edit_coupon'] == 0){echo 'disabled'; }else{ echo '';} ?>>Edit</button></a></td>
                                      </tr>
                                      <?php } ?>
                                     </tbody>
                                 </table>
...
<script src="<?=base_url()?>assets/cashier/js/loyalty_js/coupon_js.js"></script>
