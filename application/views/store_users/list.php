                ...
                <div >
                  <div class="usercardheader">
                        ...
                        <div class="col-md-10">
                          ...
                          <a href="<?=base_url('StoreUser/add')?>" type="button" class="btn btn-outline-dark alluserbtn adduserbtn">Add
                 ...
                 <div class="customcardbody2 ">
                  <table class="table table-striped" id="user_table">
                      ...
                      <tbody>
                        <?php $i=1; if(!empty($store_users)){ foreach ($store_users as $u) { ?>
                        <tr>
                          <!-- <th scope="row"></th> -->
                          <td><?=$i?></td>
                          ...
                          <td style="text-align: center;">
                              ...
                              <a href="<?=base_url('StoreUser/edit/'.$u['user_id'])?>" type="button" class="btn btn-outline-dark alluserbtn">Edit
