...
#
    ...
    //prashant code
    public function pos_register_report()
    {
       $data['title'] = "Pos Registers Report";
        $content = $this->parser->parse('report/pos_registers_report',$data,true);
        $this->template->full_admin_html_view($content);
    }
    ...
    public function inventory_report()
    {
       $data['title'] = "Inventory Report";
        $content = $this->parser->parse('report/inventory_report',$data,true);
        $this->template->full_admin_html_view($content);
    }
    ...
    public function sales_report()
    {
       $data['title'] = "Sales Report";
        $content = $this->parser->parse('report/sales_report',$data,true);
        $this->template->full_admin_html_view($content);
    }
